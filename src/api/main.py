...
from src.api.routes import webhooks, vision, admin, tools, voice, condominiums, vehicles, monitoring, bitacora
...
app.include_router(bitacora.router, prefix="/bitacora", tags=["Bitácora"])
